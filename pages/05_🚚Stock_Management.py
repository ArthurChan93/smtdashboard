...
# BAR CHART of SOUTH Instock MANAGEMENT
             ...
             with stockrow1_a:
                     st.subheader("👇:green[简易分类: 有/无定金]:moneybag:")            
...
##############################################################################################################################
             with stockrow1_b:  
                     st.subheader("👇:green[进阶分类] :open_book:")   
...
# BAR CHART of SOUTH Incoming STOCK MANAGEMENT with YAMAHA shipping schedule
             ...
             with stockrow2_a:                     
                     st.subheader("👇:blue[简易分类: 有/无定金]:moneybag:")                      
...
# 绘制图表
             ...
             with stockrow2_b:                     
                     st.subheader("👇:blue[进阶分类]:open_book:")
                     with st.expander(":point_right: Click to expand/ hide data"):
...
# BAR CHART of SOUTH STOCK MANAGEMENT No YAMAHA shipping schedule
             ...
             with stockrow3_a:      
                     st.subheader("👇:red[简易分类: 有/无定金]:moneybag:")                     
...
# 绘制图表
             ...
             with stockrow3_b:      
                     st.subheader("👇:red[进阶分类]:open_book:")
                     with st.expander(":point_right: Click to expand/ hide data"): 
