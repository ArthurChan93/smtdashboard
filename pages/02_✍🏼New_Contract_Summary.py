...
df = pd.read_excel(
                io='Monthly_report_for_edit.xlsx',engine= 'openpyxl',sheet_name='list', skiprows=0, usecols='A:AO',nrows=10000,).query('FY_Contract != "TBA"').query('FY_Contract != "Cancel"').query('Contract_Month != "TBA"').query('Contract_Month != "Cancel"').query('Region != "C66 N/A"').query('FY_Contract != "FY 16/17"').query('FY_Contract != "FY 17/18"')
